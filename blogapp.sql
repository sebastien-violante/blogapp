...
CREATE TABLE `contact` (
  `id` int NOT NULL AUTO_INCREMENT,
  `contact_subject_id` int DEFAULT NULL,
  ...
  `updated_at` datetime DEFAULT NULL COMMENT '(DC2Type:datetime_immutable)',
  PRIMARY KEY (`id`),
  KEY `IDX_4C62E638C5878510` (`contact_subject_id`),
  CONSTRAINT `FK_4C62E638C5878510` FOREIGN KEY (`contact_subject_id`) REFERENCES `contact_subject` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `doctrine_migration_versions` VALUES ('DoctrineMigrations\\Version20230517115607','2023-05-17 11:56:19',802);
...
-- Dump completed on 2023-05-17 13:57:04
